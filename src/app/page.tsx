  ...
  return (
    <div>
      <div className="mb-6 flex items-end justify-between">
        <div>
          <h1 className="font-display text-2xl font-bold sm:text-3xl">Today&apos;s Best Flips</h1>
      ...
      {deals.length === 0 ? (
        <div className="rounded-card border border-dashed border-white/20 p-10 text-center">
          ...
          <Link
            href="/upload"
            className="mt-4 inline-block rounded-card bg-paper px-4 py-2 font-medium text-ink hover:bg-paper-dim"
          >
