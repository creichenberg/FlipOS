...
export default async function SearchPage() {
  ...
  return (
    <div>
      <h1 className="font-display text-2xl font-bold sm:text-3xl">Find Deals</h1>
      <p className="mt-1 text-sm text-graphite">
        Search live eBay listings. FlipOS quick-scores every result for flip potential before you dig in.
      </p>

      {!ebayConfigured ? (
        <div className="mt-6 rounded-card border border-dashed border-white/20 p-10 text-center">
